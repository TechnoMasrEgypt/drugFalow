...
class CartState with _$CartState {
  ...
  const factory CartState.addToCartError(String message) =
    AddToCartError;
   const factory CartState.updateCartSuccess(CartResponseModel response) =
    UpdateCartSuccess;

  const factory CartState.updateCartError(String message) =
    UpdateCartError;
const factory CartState.updating() = _Updating;  // NEW

  const factory CartState.deleteCartSuccess() =
    DeleteCartSuccess;
  const factory CartState.deleteWholeCartSuccess() =
    DeleteWholeCartSuccess;
  const factory CartState.deleteCartError(String message) =
    DeleteCartError;
