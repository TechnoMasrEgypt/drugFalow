...
class _DropdownData {
  ...
  final bool visible;
  final List<SearchWarehouse> warehouse;
  const _DropdownData({
...
class _MedicineSearchFieldState extends State<MedicineSearchField> {
  ...
  void _onWarehouseTapped(SearchWarehouse warehouse) {
    _controller.clear();
    _removeOverlay();
    _focus.unfocus();
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => MultiBlocProvider(
          ...
          child: WarehouseDetailsScreen(warehouseId: warehouse.id),
        ),
      ),
    );
  }
  ...
  void _showDropdown(
    ...
    bool isLoading,
    List<SearchWarehouse> warehouses,
  ) {
          ...
          child: ValueListenableBuilder<_DropdownData>(
            ...
            builder: (_, data, __) {
              ...
              return SearchDropdown(
                onWarehouseSelect: _onWarehouseTapped, // ← add
    ...
    return BlocListener<MedicineSearchCubit, MedicineSearchState>(
      listener: (context, state) {
        state.when(
          ...
          success: (results, warehouses) =>
              _showDropdown(results, false, warehouses),
...
class SearchDropdown extends StatelessWidget {
  ...
  final List<SearchWarehouse> warehouses;
  final ValueChanged<SearchWarehouse> onWarehouseSelect; // ← add
  ...
  const SearchDropdown({
    ...
    required this.onWarehouseSelect, // ← add
  });
      ...
      child: ClipRRect(
        ...
        child: ConstrainedBox(
          ...
          child: isLoading
              ...
              : results.isEmpty && warehouses.isEmpty
              ? Padding(
                    ...
                    if (warehouses.isNotEmpty) ...[
                      ...
                      SliverList(
                        delegate: SliverChildBuilderDelegate((_, i) {
                          ...
                          return InkWell(
                            onTap: () => onWarehouseSelect(
                              wh,
                            ), // ← instead of the firstWhere crash
                      ...
                      SliverToBoxAdapter(
                        child: Divider(
                          height: 1,
                          color: color121217.withOpacity(.08),
                        ),
                      ),
                    ],
